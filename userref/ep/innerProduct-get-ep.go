...
type (
	InnerProductInfoGetService interface {
		Exec(ctx context.Context, in *InnerProductInfoGetIn) (*ykit.Result, error)
	}
...
func (r *InnerProductInfoGetH) MakeLocalEndpoint(svc InnerProductInfoGetService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		fmt.Println("#############  InnerProductInfoGet ###########")
		spew.Dump(ctx)
...
func (r *InnerProductInfoGetH) Call(id string) (*userref.Product, error) {
	...
	if i.Data != nil {
		return i.Data.(*userref.Product), nil
	}
